...
public class MainActivity extends AppCompatActivity {
    ...
    public class BuscarUsuario extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground (String... strings) {
            ...
            try {
                ...
                Result_Set = stm.executeQuery("Select * from Usuario_Propietario " +
        ...
        protected  void onPostExecute (Boolean result){
            ...
            try {
                ...
                if (Result_Set.next())
                {
                    ...
                    final String celular = Result_Set.getString(7);
                    final String ruc = Result_Set.getString(6);
                    final String Codigo_Paypal = Result_Set.getString(8);
                    SaveLoginSharedPreferences(ID, email, clave, nombre, apellido, celular, ruc, Codigo_Paypal);
                    Intent intent = new Intent(getApplicationContext(),MenuPrincipalActivity.class);
    ...
    private void SaveLoginSharedPreferences(String ID, String email, String clave, String nombre, String apellido, String celular, String RUC, String Codigo_Paypal){
        ...
        editor.putString("codigopaypal", Codigo_Paypal);
