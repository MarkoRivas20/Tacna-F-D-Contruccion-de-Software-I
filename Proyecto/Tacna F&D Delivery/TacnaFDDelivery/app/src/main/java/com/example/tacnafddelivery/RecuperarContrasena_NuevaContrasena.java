...
public class RecuperarContrasena_NuevaContrasena extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recuperar_contrasena__nueva_contrasena);getSupportActionBar().hide();
    ...
    public class ActualizarUsuario extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground (String... strings) {
            ...
            try {
                ...
                stm2.execute("Update Usuario_Repartidor set Contrasena='" + Txtnueva_Clave.getText().toString() + "' where ID_Usuario_Repartidor='" + Id_Usuario + "'");
